...
<html>
    ...
    <body>
        ...
        <table>
            ...
            <tr class="seperate">
                <td colspan="2">$25,000.00<button class="add" onclick="addToCart(this)" value="1964.5 Mustang Convertable: $25,000.00">Add To Cart</button></td>
            </tr>
            <tr>
            ...
            <tr class="seperate">
                <td colspan="2">$45,000.00<button class="add" onclick="addToCart(this)" value="1965 Mustang Shelby GT350: $45,000.00">Add ToCart</button></td>
            </tr>
            <tr>
            ...
            <tr class="seperate">
                <td colspan="2">$65,000.00<button class="add" onclick="addToCart(this)" value="1967 Mustang Shelby GT500: $65,000.00">Add To Cart</button></td>
            </tr>
            <tr>
            ...
            <tr class="seperate">
                <td colspan="2">$300,000.00<button class="add" onclick="addToCart(this)" value="1969 Mustang Boss 429: $300,000.00">Add To Cart</button></td>
            </tr>
        </table>
    </body>
</html>